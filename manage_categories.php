...
<body style="background-image: url('cat.PNG');">
	<!-- Navbar -->
	<?php include_once("./templates/header.php"); ?>
	<br/><br/>
	
	<h2 style="text-align:center; color:#F5EEEE; font-size: 3em;">Categories Details 🛒</h2><br>
<div class = "table" >
<table border="2" bgcolor="#6BFFD6">
  <tr class="head">
    <td>Category ID</td>
...
?>
  <tr>
    ...
    <td><?php echo $data['parent_cat']; ?></td>
