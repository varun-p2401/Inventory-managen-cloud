			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>Jagadeesh Sudharshan</p>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Here you can see your categories and you add new parent and sub categories</p>
						<a href="#" data-toggle="modal" data-target="#form_category" class="btn btn-primary">Add</a>
						<a href="manage_categories.php" class="btn btn-primary">Fetch</a>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Here you can see your brand and you add new brand</p>
						<a href="#" data-toggle="modal" data-target="#form_brand" class="btn btn-primary">Add</a>
						<a href="manage_brand.php" class="btn btn-primary">Fetch</a>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Here you can see your prpducts and you add new products</p>
						<a href="#" data-toggle="modal" data-target="#form_products" class="btn btn-primary">Add</a>
						<a href="manage_product.php" class="btn btn-primary">Fetch</a>
					</div>
				</div>
			</div>
		</div>
